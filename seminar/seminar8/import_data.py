...
def edit_student():
    ...
    surname = input("Введите правильную фамилию ученика: ")
    name = input("Введите правильное имя ученика: ")
    otch = input("Введите правильное отчество ученика: ")
    birth = input("Введите правильную дату рождения ученика: ")
    tel = input("Введите правильный телефон ученика: ")
    adress = input("Введите правильный адрес ученика: ")
